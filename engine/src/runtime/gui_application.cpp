// #include "eng/runtime/gui_application.h"
...
// GuiApp::GuiApp(const std::string& name, CommandLineArgs args) : Application(args) {
//     PROFILE_FUNCTION();
...
// 	m_window->set_event_cb(ENG_BIND_EVENT_FN(GuiApp::on_event));
...
// void GuiApp::push_layer(Layer* layer) {
//     m_stack.push_layer(layer);
//     layer->on_attach();
// }

// void GuiApp::push_overlay(Layer* layer) {
//     m_stack.push_overlay(layer);
//     layer->on_attach();
// }

// void GuiApp::on_event(Event& e) {
//     EventDispatcher dispatcher(e);
//     dispatcher.dispatch<WindowCloseEvent>(ENG_BIND_EVENT_FN(GuiApp::on_window_close));
//     dispatcher.dispatch<WindowResizeEvent>(ENG_BIND_EVENT_FN(GuiApp::on_window_resize));
...
// bool GuiApp::on_window_resize(WindowResizeEvent& e) {
//     PROFILE_FUNCTION();
...
// bool GuiApp::on_window_close(WindowCloseEvent& e) {
//     m_running = false;
//     return true;
// }
