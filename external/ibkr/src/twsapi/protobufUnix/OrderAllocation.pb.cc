...
PROTOBUF_NDEBUG_INLINE OrderAllocation::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::protobuf::OrderAllocation& from_msg)
...
OrderAllocation::_table_ = {
  {
    ...
    // optional string account = 1;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.account_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string position = 2;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.position_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string positionDesired = 3;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.positiondesired_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string positionAfter = 4;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.positionafter_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string desiredAllocQty = 5;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.desiredallocqty_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string allowedAllocQty = 6;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.allowedallocqty_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional bool isMonetary = 7;
    {PROTOBUF_FIELD_OFFSET(OrderAllocation, _impl_.ismonetary_), _Internal::kHasBitsOffset + 6, 0, (0 | ::_fl::kFcOptional | ::_fl::kBool)},
  }},
  // no aux_entries
  {{
