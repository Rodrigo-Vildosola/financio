...
PROTOBUF_NDEBUG_INLINE ComboLeg::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::protobuf::ComboLeg& from_msg)
...
ComboLeg::_table_ = {
  {
    ...
    // optional int32 conId = 1;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.conid_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional int32 ratio = 2;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.ratio_), _Internal::kHasBitsOffset + 4, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional string action = 3;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.action_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional string exchange = 4;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.exchange_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional int32 openClose = 5;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.openclose_), _Internal::kHasBitsOffset + 5, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional int32 shortSalesSlot = 6;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.shortsalesslot_), _Internal::kHasBitsOffset + 6, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional string designatedLocation = 7;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.designatedlocation_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
    // optional int32 exemptCode = 8;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.exemptcode_), _Internal::kHasBitsOffset + 8, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional double perLegPrice = 9;
    {PROTOBUF_FIELD_OFFSET(ComboLeg, _impl_.perlegprice_), _Internal::kHasBitsOffset + 7, 0, (0 | ::_fl::kFcOptional | ::_fl::kDouble)},
  }},
  // no aux_entries
  {{
