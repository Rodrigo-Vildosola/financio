...
PROTOBUF_NDEBUG_INLINE CancelOrderRequest::Impl_::Impl_(
    ...
    [[maybe_unused]] const ::protobuf::CancelOrderRequest& from_msg)
...
CancelOrderRequest::_table_ = {
  {
    ...
    // optional int32 orderId = 1;
    {PROTOBUF_FIELD_OFFSET(CancelOrderRequest, _impl_.orderid_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional .protobuf.OrderCancel orderCancel = 2;
    {PROTOBUF_FIELD_OFFSET(CancelOrderRequest, _impl_.ordercancel_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
  }},
  {{
