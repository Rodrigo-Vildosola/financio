...
DeltaNeutralContract::_table_ = {
  {
    ...
    // optional int32 conId = 1;
    {PROTOBUF_FIELD_OFFSET(DeltaNeutralContract, _impl_.conid_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional double delta = 2;
    {PROTOBUF_FIELD_OFFSET(DeltaNeutralContract, _impl_.delta_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kDouble)},
    // optional double price = 3;
    {PROTOBUF_FIELD_OFFSET(DeltaNeutralContract, _impl_.price_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kDouble)},
  }},
  // no aux_entries
  {{
  }},
